<template>
  <div class="col-md-6 col-lg-4 col-sm-12 justify-content-between py-4">
    <div v-if="(apartment.images[0].link.startsWith('https://') || apartment.images[0].link.startsWith('http://'))">
        <img class="rounded-1 w-100" :src="apartment.images[0].link" :alt="apartment.title">
    </div>
    <div v-else>
        <img class="rounded-1 w-100" :src="apartment.images[0].link" :alt="apartment.title">
    <div>
